...
app.get("/:id", (req, res) => {
    ...
    res.render("index", {"name": driver.name,"carNumber": driver.carNumber,"age": driver.age,"team": driver.team,"home": driver.home,"championship": driver.championship,"wins": driver.wins, "desc": driver.desc})
})
